...
public class IceCreamStack {
    ...
    public void resize() {
        ...
        System.out.println(this.iceCreamScoops.length);
        String[] resizer = new String[2*this.iceCreamScoops.length];
        System.out.println(resizer.length);
        for(int i=0; i<this.iceCreamScoops.length; i++){
            resizer[i] = this.iceCreamScoops[i];
        }
        this.iceCreamScoops = resizer;
        System.out.println(this.iceCreamScoops.length);
    }
    ...
    public void push(String flavor) {
        // WRITE YOUR CODE HERE
        if(next == this.iceCreamScoops.length){
            resize();
        }
        this.iceCreamScoops[next] = flavor;
        next++;
    }
